...
class Entrada(Base):
    ...
    id_reserva = Column(ForeignKey('reserva.id_reserva', ondelete='RESTRICT', onupdate='CASCADE'))
    id_emprestimo = Column(ForeignKey('emprestimo.id_emprestimo', ondelete='RESTRICT', onupdate='CASCADE'))
